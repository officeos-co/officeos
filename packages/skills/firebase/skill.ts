...
export default defineSkill({
  ...
  credentials: {
    project_id: {
      ...
      help: "Firebase/GCP project ID found in Project Settings.",
    },
    api_key: {
      label: "Web API Key",
      kind: "password",
      placeholder: "AIzaSy...",
      help: "Firebase Web API Key found in Project Settings > General > Web API Key.",
    },
  },
