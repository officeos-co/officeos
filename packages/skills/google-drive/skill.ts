...
export default defineSkill({
  ...
  credentials: {
    access_token: {
      ...
      kind: "password",
      placeholder: "ya29.\u2026",
      help: "Google OAuth2 access token with Drive scopes.",
    },
  },
