...
export default defineSkill({
  ...
  credentials: {
    proxy_url: {
      label: "Proxy URL",
      kind: "text",
      placeholder: "https://api.officeos.co/postgres",
      help: "Backend proxy endpoint for PostgreSQL queries.",
    },
    database: {
      label: "Database",
      kind: "text",
