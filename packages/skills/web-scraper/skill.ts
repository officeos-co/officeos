...
export default defineSkill({
  ...
  credentials: {
    proxy_url: {
      label: "Proxy URL / API Key",
      kind: "password",
      placeholder: "https://user:pass@proxy.example.com:8080 or ScrapingBee API key",
      help: "HTTP proxy URL with embedded credentials, or your ScrapingBee API key.",
    },
  },
