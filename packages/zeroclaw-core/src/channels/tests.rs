...
// AIEOS identity tests removed in Phase 3 — the AIEOS JSON path was
// deleted entirely and the build_system_prompt flow now sources
// identity exclusively from the markdown files in workspace_dir (which
// the dashboard backend mounts as a K8s ConfigMap). See STRIP_DOWN.md
// Phase 3 and docs/reference/identity-vault.md.
