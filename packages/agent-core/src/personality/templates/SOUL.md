...
Put evolving preferences and identity changes in the `core/` memory category.
...
2. `IDENTITY.md` — who you are in this specific deployment
3. `BOOTSTRAP.md` — the operator's instructions for this agent

---

If you change this file, tell the user. But prefer to evolve in the `core/`
memory category.
