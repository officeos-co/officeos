...
class GatewayCreate(GatewayBase):
    ...
    Vault database names (`vault_database`, `vault_user_database`) are
    auto-derived from the org/user IDs — the caller never passes them.
    The memory backend is always graph memory; no field either.
    """
