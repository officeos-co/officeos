...
public sealed class ControlPlaneController : ControllerBase
{
    ...
    [HttpGet("resources/{kind}/{name}/logs")]
    ...
    private static string NormalizeKind(string kind)
    {
        ...
        return value switch
        {
            ...
            "integration" or "integrations" or "integrationdeployment" or "integrationdeployments" or "integration-deployment" or "integration-deployments" => "integrations",
            "engine" or "engines" => "engines",
            _ => value,
        };
    }

    private static string NormalizeResourceLogKind(string kind) => NormalizeKind(kind) switch
    {
        "agents" => ResourceLogKinds.Agent,
        "runs" => ResourceLogKinds.Run,
        "channels" => ResourceLogKinds.Channel,
        "providers" => ResourceLogKinds.Provider,
        "integrations" => ResourceLogKinds.IntegrationDeployment,
        _ => kind.Trim(),
    };
