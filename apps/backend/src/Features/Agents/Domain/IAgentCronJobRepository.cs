...
public interface IAgentCronJobRepository
{
    ...
    Task<IReadOnlyList<AgentCronJobWithAgentRecord>> ListForOwnerAsync(Guid ownerId, Guid? workspaceId = null, CancellationToken ct = default);
    ...
    Task<AgentCronJobWithAgentRecord?> GetForOwnerAsync(Guid id, Guid ownerId, Guid? workspaceId = null, CancellationToken ct = default);
