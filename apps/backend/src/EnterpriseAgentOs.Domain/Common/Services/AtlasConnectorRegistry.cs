...
public static class AtlasConnectorRegistry
{
    ...
    [
        ...
        new()
        {
            ...
            Provider = "github",
            Title = "GitHub",
            Description = "Atlas-compatible GitHub connector that indexes repositories, issues, pull requests, and commits into the Context Store while preserving direct GitHub API calls for fresh data.",
            Subtitle = "Index repositories, issues, pull requests, and commits for agent search",
            ...
            ToolsJson = """[{"name":"connector_execute","description":"Execute Atlas-compatible GitHub actions through context_store_search or direct API calls"}]""",
            Category = "developer",
