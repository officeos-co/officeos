...
{
    Task<IReadOnlyList<AgentDto>> ListAsync(AgentFilter filter, CancellationToken ct = default);
    Task<AgentDto?> GetByAsync(AgentFilter filter, CancellationToken ct = default);
