...
{
    Task<IReadOnlyList<MemoryStoreRecord>> ListAsync(Guid ownerId, CancellationToken ct = default);
    Task<MemoryStoreRecord?> GetAsync(Guid id, Guid ownerId, CancellationToken ct = default);
    ...
    Task<IReadOnlyList<MemoryStoreEntryRecord>> ListEntriesAsync(Guid memoryStoreId, Guid ownerId, CancellationToken ct = default);
