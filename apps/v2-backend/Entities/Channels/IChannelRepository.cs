...
public interface IChannelRepository
{
    ...
    Task<ChannelConnectionRecord?> GetConnectionAsync(Guid id, CancellationToken ct = default);
    ...
    Task<AgentChannelBindingRecord?> GetBindingAsync(Guid bindingId, CancellationToken ct = default);
