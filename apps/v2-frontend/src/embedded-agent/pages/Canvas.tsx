  ...
  return (
    <div className="p-6 space-y-4 h-full flex flex-col">
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                <p
                  ...
                  style={{ color: "var(--pc-text-muted)" }}
                >
                  Waiting for content on canvas{" "}
                  <span className="font-mono">"{canvasId}"</span>
                </p>
                <p
                  className="text-xs mt-1"
                  style={{ color: "var(--pc-text-muted)", opacity: 0.6 }}
                >
      ...
      {currentFrame && (
        ...
        >
          <span>
            Type: <span className="font-mono">{currentFrame.content_type}</span>{" "}
            | Frame:{" "}
