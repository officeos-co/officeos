...
public interface ISessionRepository {
    CompletableFuture<SessionModel> createAsync(UUID userId, String tokenHash, Instant expiresAt);
    CompletableFuture<SessionModel> getByTokenHashAsync(String tokenHash);
