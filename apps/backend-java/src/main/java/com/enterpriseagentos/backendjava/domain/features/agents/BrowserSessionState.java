...
public record BrowserSessionState(UUID agentId, String runtimeSessionId, String status, String name, String currentUrl, String title, String takeoverUrl, Instant createdAt, Instant lastAccessedAt) {
}
