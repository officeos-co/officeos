...
public record ToolCallCompletedEvent(UUID agentId, String correlationId, String toolName, boolean success, String output, int durationMs) implements DomainEvent {
}
