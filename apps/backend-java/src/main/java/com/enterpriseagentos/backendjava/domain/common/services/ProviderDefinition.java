...
public record ProviderDefinition(String slug, String displayName, ApiFormat apiFormat, String baseUrl, String platformKeyConfigName, List<ModelDefinition> models) {
}
