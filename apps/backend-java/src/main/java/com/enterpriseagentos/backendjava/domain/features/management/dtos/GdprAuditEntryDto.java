...
public final class GdprAuditEntryDto  {
    ...
    public GdprAuditEntryDto(UUID id, UUID agentId, String skillName, String action, String paramsJson, String resultSummary, long durationMs, Instant timestamp) {
        this.id = id;
