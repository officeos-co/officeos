...
public record AgentLogDto(UUID id, UUID agentId, String agentName, Instant time, AgentLogType type, String tool, String integration, String channel, String content, int durationMs, int inputTokens, int outputTokens, String correlationId) {
}
