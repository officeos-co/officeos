...
public final class GlobalLogRow  {
    private final AgentLogModel log;
    private final String agentName;

    public GlobalLogRow(AgentLogModel log, String agentName) {
        this.log = log;
        this.agentName = agentName;
    }

    public AgentLogModel getLog() {
        return log;
}

    public AgentLogModel log() {
        return log;
    }
