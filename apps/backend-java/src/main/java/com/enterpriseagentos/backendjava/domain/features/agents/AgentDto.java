...
public record AgentDto(UUID id, String name, String provider, String model, String prompt, String status, String podName, String serviceUrl, Instant createdAt) {
}
