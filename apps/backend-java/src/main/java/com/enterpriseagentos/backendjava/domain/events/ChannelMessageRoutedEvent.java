...
public record ChannelMessageRoutedEvent(UUID agentId, AgentLogType logType, String channelType, String content, String correlationId) implements DomainEvent {
}
