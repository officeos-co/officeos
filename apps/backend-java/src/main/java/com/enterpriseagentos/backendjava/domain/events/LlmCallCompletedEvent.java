...
public record LlmCallCompletedEvent(UUID agentId, String correlationId, String model, int durationMs, int inputTokens, int outputTokens) implements DomainEvent {
}
