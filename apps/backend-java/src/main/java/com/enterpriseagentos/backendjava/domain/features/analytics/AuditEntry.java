...
public record AuditEntry(UUID id, UUID agentId, UUID userId, String skillName, String action, String paramsJson, String resultSummary, long durationMs, Instant timestamp) {
}
