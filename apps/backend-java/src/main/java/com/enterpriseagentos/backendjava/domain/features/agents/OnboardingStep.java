...
public record OnboardingStep(String type, String title, String description, String value, String inputKey, String inputLabel, String inputPlaceholder, String inputHelp, String inputKind, boolean inputRequired) {
}
