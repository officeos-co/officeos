...
public record ChannelConnectionDto(UUID id, String channelType, String displayName, boolean enabled, boolean configured, Instant createdAt, UUID createdById) {
}
