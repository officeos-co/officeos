...
public interface IAgentLogService {
    CompletableFuture<List<AgentLogModel>> listForAgentAsync(UUID agentId, Instant before, int limit);
    ...
    CompletableFuture<AgentLogModel> sendMessageAsync(UUID agentId, String content, UUID userId);
