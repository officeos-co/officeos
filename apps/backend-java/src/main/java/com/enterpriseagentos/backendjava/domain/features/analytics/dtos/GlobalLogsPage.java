...
public final class GlobalLogsPage  {
    private final List<AgentLogDto> items;
    private final int total;

    public GlobalLogsPage(List<AgentLogDto> items, int total) {
        this.items = items;
        this.total = total;
    }

    public List<AgentLogDto> getItems() {
        return items;
}

    public List<AgentLogDto> items() {
        return items;
    }
