...
public interface IOrganizationService {
    CompletableFuture<OrgMemberModel> inviteMemberAsync(UUID callerUserId, String callerEmail, String callerName, String memberEmail, String role);
    CompletableFuture<Boolean> removeMemberAsync(UUID callerUserId, String callerEmail, String callerName, UUID memberId);
    CompletableFuture<OrganizationModel> renameAsync(UUID callerUserId, String callerEmail, String callerName, String name);
    CompletableFuture<List<OrgMemberModel>> listMembersAsync(UUID callerUserId, String callerEmail, String callerName);
}
