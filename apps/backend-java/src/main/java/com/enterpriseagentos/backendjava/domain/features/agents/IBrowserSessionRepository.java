...
public interface IBrowserSessionRepository {
    CompletableFuture<BrowserSessionRecord> getByAgentAsync(UUID agentId);
    CompletableFuture<BrowserSessionRecord> upsertAsync(UUID agentId, String runtimeSessionId, String cookiesJson);
