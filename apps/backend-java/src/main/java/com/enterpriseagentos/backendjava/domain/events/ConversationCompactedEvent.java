...
public record ConversationCompactedEvent(UUID agentId, String correlationId, UUID lastCompactedLogId, int preCompactTokens, int postCompactTokens) implements DomainEvent {
}
