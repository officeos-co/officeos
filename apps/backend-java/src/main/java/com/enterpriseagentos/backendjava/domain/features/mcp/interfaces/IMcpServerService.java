package com.enterpriseagentos.backendjava.domain.features.mcp.interfaces;
...
public interface IMcpServerService {
    CompletableFuture<List<McpServerModel>> listAsync();
    CompletableFuture<McpServerModel> getAsync(String name);
    CompletableFuture<McpServerModel> registerAsync(McpServerModel server);
    CompletableFuture<Void> deleteAsync(String name);
    CompletableFuture<List<McpServerModel>> listForAgentAsync(UUID agentId);
