...
public interface IAuthService {
    ...
    CompletableFuture<GoogleCallbackResult> handleGoogleCallbackAsync(String code);
    GitHubLoginResult buildGitHubLoginUrl();
    CompletableFuture<GitHubCallbackResult> handleGitHubCallbackAsync(String code);
}
