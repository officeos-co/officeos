...
public interface IUserRepository {
    CompletableFuture<UserModel> upsertByGoogleSubjectAsync(String googleSubjectId, String email, String name, String avatarUrl);
    CompletableFuture<UserModel> upsertByGitHubSubjectAsync(String gitHubSubjectId, String email, String name, String avatarUrl);
    CompletableFuture<UserModel> getByIdAsync(UUID id);
