---
title: Vault System
description: "How agent identity files flow from templates to CouchDB to agent pod, and the knowledge graph philosophy behind it."
---
...
- **Cache hit**: all required files exist non-empty on PVC → skip CouchDB fetch, boot in under 100ms
