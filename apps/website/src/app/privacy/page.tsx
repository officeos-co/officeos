...
export const metadata = {
	...
	description:
		"How Office OS collects, processes, and protects your data.",
};
				...
				<div className="mt-16 space-y-12 text-muted-foreground leading-relaxed">
					...
					<section>
						<p>
							...
							<strong className="text-primary">harrokrog.com</strong>. This
					...
					<section>
						...
						<ul className="space-y-3 list-disc pl-5">
							...
							<li>
								<strong className="text-primary">Agent data</strong> — personality
								files, workspace content, and configuration stored in per-agent
								CouchDB vaults.
							</li>
							<li>
								<strong className="text-primary">LLM call logs</strong> — prompts
								and completions routed through our backend proxy are logged for
					...
					<section>
						...
						<p>
							...
							session management is handled transparently by the backend. Browser
							session data is deleted when the associated agent is deleted.
						</p>
					</section>
					...
					<section>
						...
						<ul className="mt-3 space-y-3 list-disc pl-5">
							<li>
								<strong className="text-primary">Data portability (Art. 20)</strong> —
							...
							<li>
								...
								you can delete your account and all associated agent data at any
								time through the dashboard or by contacting us.
							</li>
							<li>
								<strong className="text-primary">Data processing basis</strong> —
								we process your data based on contractual necessity (to provide
					...
					<section>
						...
						<p>
							...
							role-based access controls, and isolated Kubernetes pods per agent.
							All infrastructure runs in a single-tenant, self-hosted
							architecture.
						</p>
					</section>
					...
					<section>
						...
						<p>
							...
							<a
								href="mailto:privacy@harrokrog.com"
								className="text-primary underline underline-offset-4 hover:text-primary/80"
							>
								privacy@harrokrog.com
							</a>
							.
						</p>
					</section>
