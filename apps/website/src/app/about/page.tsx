      ...
      <main className="flex min-h-screen w-full flex-col items-center">
        <div className="mx-auto max-w-4xl w-full px-6 pt-20 pb-28 md:pt-28">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed text-center">
            Structuring agentic work for organizations — so every team can
            deploy, connect, and control their own AI agents.
          </p>
          ...
          <div className="mt-20 space-y-8 text-muted-foreground leading-relaxed text-lg">
            <p>
              ...
              aren&apos;t shared. Credentials aren&apos;t centralized. Nothing
              is organized.
            </p>
            <p>
              ...
              We&apos;re building the intelligence layer for autonomous AI
              agents — a Kubernetes-native platform where agents are deployed in
              seconds, share a central knowledge graph, and execute skills that
              run real business logic on your infrastructure.
            </p>
            <p>
              Think of it as{" "}
              <strong className="text-primary">
              ...
              Credentials are managed once, used by all agents. Skills are
              written in TypeScript, deployed instantly, and executed in
              sandboxed V8 isolates — not containers, not VMs.
            </p>
            <p>
              The architecture is fundamentally different from managed agent
              platforms that run prompts in the cloud with only MCP server
              access. Our agents run as lightweight Rust binaries in Kubernetes
              pods — each using just megabytes of resources — with full system
              control and deep integration into any software that exposes an
              API.
            </p>
            <p>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="text-center">
                ...
                <p className="mt-3 max-w-md text-sm text-muted-foreground leading-relaxed">
                  ...
                  that don&apos;t know each other, tools that aren&apos;t
                  shared, credentials scattered everywhere.
                </p>
              </div>
            </div>
          </div>
