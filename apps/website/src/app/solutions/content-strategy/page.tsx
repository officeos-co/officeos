				...
				<div className="mt-16 space-y-12 text-muted-foreground leading-relaxed">
					<section>
						...
						<p>
							...
							. It doesn&apos;t brainstorm in a vacuum — it identifies
							topics based on what&apos;s actually happening in your market,
							what your customers are asking about, and what your
							organization uniquely knows.
						</p>
						<p className="mt-4">
							A customer success ticket about a recurring pain point
							becomes a thought leadership article. An internal engineering
							breakthrough becomes a technical deep dive. The agent
							connects signals that a content team working in isolation
							would miss.
						</p>
					</section>
					...
					<section>
						...
						<p>
							...
							<strong className="text-primary">angles</strong>. For every
							topic, it analyzes what competitors have already published,
							identifies gaps in the conversation, and determines which
							perspective differentiates your content. The goal isn&apos;t
							more content — it&apos;s content that stands out.
						</p>
						<p className="mt-4">
							If three competitors already published &quot;How to
							implement X,&quot; the agent doesn&apos;t suggest a fourth
							version. It finds the angle that leverages your unique
							expertise and positions your organization as the authority.
						</p>
					</section>
					...
					<section>
						...
						<p>
							Not every topic deserves the same format. The agent evaluates
							each topic and recommends the right format:{" "}
							<strong className="text-primary">
								LinkedIn post, technical deep dive, case study, newsletter
								segment, or video script
							</strong>
							. It considers your audience, the topic complexity, and where
							in the buyer journey each piece fits.
						</p>
						<p className="mt-4">
							The result is a content calendar that&apos;s strategically
							planned — not a random list of blog post ideas, but a
							coherent narrative arc across formats and channels.
						</p>
					</section>
					...
					<section>
						...
						<p>
							The agent produces full drafts — not outlines, not bullet
							points. These drafts are informed by your knowledge graph,
							your brand voice guidelines, and the competitive analysis
							it already performed. A human reviews, refines, and
							approves. The creative direction stays with your team; the
							heavy lifting is handled.
						</p>
						<p className="mt-4">
							One content person with this agent produces the output of a
							small content team. Not by cutting corners, but by
							eliminating the research, planning, and first-draft phases
					...
					<section>
						...
						<p>
							...
							what&apos;s actually true about your company, not generic
					...
					<section>
						...
						<div className="space-y-4">
							<div className="flex gap-4">
								...
								<p>
									The agent scans industry news, customer feedback
									channels, and internal knowledge for content
									opportunities.
								</p>
							</div>
							<div className="flex gap-4">
								...
								<p>
									For each topic, it analyzes competitive content,
									identifies differentiating angles, and recommends the
									optimal format.
								</p>
							</div>
							<div className="flex gap-4">
								...
								<p>
									It produces full drafts informed by your knowledge
									graph, brand guidelines, and competitive positioning.
								</p>
							</div>
							<div className="flex gap-4">
								<span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-secondary/10 text-sm font-bold text-secondary">
								...
								<p>
									Your team reviews, refines, and publishes. The
									strategic thinking and heavy lifting are already done.
								</p>
							</div>
						</div>
					</section>
