...
const individualPlans = [
  {
    ...
    period: null,
    cta: "Start Free",
    ctaHref: "https://dashboard.officeos.co",
    highlight: false,
    prefix: null,
    features: [
      "1 concurrent agent",
    ...
    <div className="min-h-screen bg-background text-primary font-sans">
      ...
      <main className="mx-auto max-w-4xl px-6 pt-20 pb-28 md:pt-28">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed text-center">
          Self-hosted Kubernetes deployment. Full system control. Scale as your
          agent fleet grows.
        </p>
        ...
        <p className="text-center text-xs text-muted-foreground/60 mt-10">
          Prices shown don&apos;t include applicable tax. Yearly billing saves
          20%.
        </p>
